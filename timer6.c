...
// Ќужно дл€ сообщений об ошибках в правом нижнем углу
...
void InitTimer6(void)
{
	...
	TIM6->CR1 |= TIM_CR1_CEN; // первое включение, почему-то без него не желает работать(сразу выключаетс€, не проработав 3 секунды)
}
